...
$sqlEmployee = "SELECT user_id, admin_name FROM user";
$resultEmployee = $conn->query($sqlEmployee);

/* Check if any data is fetched
if ($resultEmployee->num_rows == 0) {
    // Redirect to the registration page if no data is fetched
    ("Location:../registration.php");
    exit();
} else {
    // Redirect to the login page if data is fetched
            ...
            <div class="content">
                        ...
                        <div class="title-2">
                            <div class="heading">
                                ...
                                if ($resultEmployee->num_rows > 0) {
                                    ...
                                    $employeeId = $rowEmployee['user_id'];

                                    echo "<p class='text-wrapper-3'>Good to see you, " . $rowEmployee['admin_name'] . " 👋</p>";
                                } else {
                ...
                <div class="tracking">
                    <div class="container-2">
                        ...
                        $sql = "SELECT approval_status FROM leaverequest";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            // Output total leave taken
                            echo '<div class="div-3">';
                            echo '<div class="text-wrapper-6">Total leave avaliable</div>';
                            echo '<div class="text-wrapper-7">' . $totalLeaveCount . '</div>';
                        ...
                        // Query to fetch leave information from the database
                        $sql = "SELECT approval_status FROM attendance";
                        $result = $conn->query($sql);
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo '<div class="text-wrapper-9">' . ($totalAttendanceCount - $approvedAttendanceCount) . '</div>';
                            echo '</div>';

                            // Output number of leave requests not accepted
                            echo '<div class="info">';
                            echo '<div class="text-wrapper-8">Attendance Not Accepted</div>';
                            echo '<div class="text-wrapper-10">' . $approvedAttendanceCount . '</div>';
                            echo '</div>';
                    ...
                    <div class="container-3">
                        ...
                        <div class="long-container">
                            ...
                            <div class="div-6">
                                ...
                                $sql = "SELECT SUM(TIMESTAMPDIFF(SECOND, punch_in, punch_out)) AS total_hours FROM attendance";
                                $result = $conn->query($sql);
