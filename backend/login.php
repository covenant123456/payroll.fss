...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM user WHERE email = '$email' AND pin = '$pin'";
    ...
    if ($result->num_rows == 1) {
        ...
        // Retrieve and store the user role in the session
        ...
        <div class="overlap-group-wrapper">
            <div class="overlap-group">
                <form class="modal-2" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="buttons-2">
                        <button class="button"><input type="submit" value="Login"></button>
                    </div>
                </form>
                <?php
