...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // $employeeID = $_POST['employee_id'];
    ...
    $insertQuery = "INSERT INTO leaverequest (employee_id, name,type, date, duration, reason) 
                    VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($insertQuery);
    $stmt->bind_param("ssssss", $employee_id, $employeeName, $leaveType, $leaveDate, $leaveDuration, $leaveReason);
            ...
            <div class="form-list">
              ...
              <div class="frame-2">
                <div class="input-label-2">
                  <div class="container-2">
                    <div class="label-text">
                      <div class="label-4">Duration (days)</div>
                    </div>
                  </div>
